package com.ggg.rememo.feature.timeline.view;
...
/**
 * 自定义 ItemDecoration: 绘制一条贯穿始终的发光琥珀金脊索
 */
public class TimelineSpineDecoration extends RecyclerView.ItemDecoration {

    private final Paint paint;
    private final Paint glowPaint;
    private final int lineXOffset;

    public TimelineSpineDecoration(Context context) {
        ...
        glowPaint.setStrokeWidth(dpToPx(context, 6)); // 更粗的线作为发光底
    ...
    public void onDraw(@NonNull Canvas c, @NonNull RecyclerView parent, @NonNull RecyclerView.State state) {
        ...
        // 绘制一条贯穿整个可见区域的线
        // 使用 ItemDecoration 可以保证线绝对连贯，不会因为 Item 之间的 margin 而断裂
